    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        }else if(id == R.id.action_increase)
        {
            if(size < max) {
                ...
                Toast.makeText(getApplicationContext(),"Sorry,this is the maximum size.",Toast.LENGTH_SHORT).show();
            }
        ...
        }else if(id == R.id.action_decrease)
        {
            if(size > min) {
                ...
                // getApplicationContext() = this
                Toast.makeText(getApplicationContext(),"Sorry,this is the minimum size.",Toast.LENGTH_SHORT).show();
            }
